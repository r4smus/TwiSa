...
public class TwisaBackendController {
    ...
    private void initTestData1() {
    	...
    	Tweet tweet1 = new Tweet(1, "RT @dulce_marquezz: Holaaa #TorreÃ³n https://t.co/dZseWPe4BL", "es", user2, 41.529356f, -2.545587f, "Twitter Web Client");
    	...
    	Tweet tweet7 = new Tweet(7, "Super FCA! Weiter so!!!","de",user4, 48.403275f, 10.845050f, "Twitter Web Client");
    	Tweet tweet8 = new Tweet(8, "Tooooooooooor, perfekter Schuss von Gregoritsch. #FCA","de",user5, 48.291469f, 10.658969f, "Twitter for iPhone");
    	Tweet tweet9 = new Tweet(9, "Heut gibts Zwetschgendatschi #Lecker","de",user4, 48.434264f, 10.714587f, "Twitter for iPhone");
    	Tweet tweet10 = new Tweet(10, "Ich geh mal schlafen. #müde","de",user5, 48.357670f, 10.783938f, "Twitter Web Client");
